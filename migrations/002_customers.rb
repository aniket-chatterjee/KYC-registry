Sequel.migration do
  up do
    create_table(:customers) do
      ...
      String      :maiden_name_prefix, null:false, size:3
      String      :maiden_first_name, null:false, size:11
      String      :maiden_middle_name, size:11
      String      :maiden_last_name, null:false, size:11
      ...
      foreign_key :country_id, :countries, unique: true, :on_delete=>:set_null
